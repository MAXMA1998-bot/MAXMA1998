...
def callback_query(call):
    ...
    # اشتراك ماكس (العروض المميزة المدفوعة)
        ...
        my_names = ["💀 واتساب بلس", "👑 يوزرات مميزة", "اكواد تعطيل 😈", "📷 فتح كاميرا", "📍 تحديد موقع", "☠️ رفع تيكتوك", "✅ أرقام فيك", "👀 انستا برايفت", "➕ فك سافيوم", "🛠 أدوات متطورة", "✨ مزايا انستا", "🌎 تلغيم روابط", "🎮 شحن ألعاب", "✅ رشق انستا", "🚀 تطبيقات برو", "📱 بلياردو لانهائي", "🤖 تيكتوك ترول", "ادوات اختراق ☠️", "✅ أرقام حقيقية خاصة بك", "اتصال وهمي ☎️"]
        markup = types.InlineKeyboardMarkup(row_width=2)
